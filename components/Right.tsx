    ...
    return (
        <section className='p-4 space-y-8 pr-8'>
            <div className="flex space-x-2 items-center justify-between">
                {/* Icons */}
                <div className="xl:hidden flex items-center space-x-4 border-2 border-[#262626] rounded-full h-12 py-3 px-4">
            ...
            <div className="bg-[#0d0d0d] border-2 p-4 border-[#262626] rounded-xl ">
                ...
                <div className="space-y-4 overflow-y-scroll overflow-x-hidden h-[250px] md:h-[400px] scrollbar-hide">
                    {recentlyPlayed.map((track, index) => {
                        console.log('a',track)
                        return <RecentlyPlayed chooseTrack={chooseTrack} track={track} key={index} />
                    })}
                </div>
